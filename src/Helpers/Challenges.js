...
export default class Challenges {
  ...
  static starter_challenges = [
    ...
    [ 'FMK', 'The group picks 3 people. Pick your options to F***, Marry, and Kill.' ],
    ...
    [ '21', 'Play 21 until you reach 21 three times. If you mess up, you drink!' ],
    [ 'Musical Heads Up', 'Get the Heads Up app and do the musical category.' ],
    [ 'Hot Seat', 'Everyone gets 120 seconds to ask you questions. Answer fast or drink.' ],
